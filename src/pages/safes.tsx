...
export const Safes = () => {
  ...
  return (
    <section className="text-gray-600 body-font bg-[#F4F3FA] h-screen">
          <div className="container px-5 py-24 mx-auto flex flex-wrap gap-x-10 gap-y-7">
            
              {safes.map(each=>
              <Link key={each} to={`/my-safe/${each}`}>
                  <div className="flex flex-wrap -m-4 text-center">
                <div className="p-4">
                    <div className=" flex items-center  justify-between p-4 gap-x-4  rounded-lg bg-white shadow-indigo-50 shadow-md">
                    <div>
                        ...
                        <h3 className="mt-2 text-xl font-bold text-green-500 text-left"></h3>
                            <button className="text-sm mt-6 px-4 py-2 bg-button text-white !rounded-lg font-laonoto tracking-wider hover:bg-indigo-500 outline-none">View</button>
                    </div>
                    <div
                        className="bg-button w-20 h-20 text-white rounded-full shadow-2xl shadow-[#1b3a66] border-white  border-dashed border-2  flex justify-center items-center ">
                        <div>
